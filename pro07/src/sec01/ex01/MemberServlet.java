...
public class MemberServlet extends HttpServlet {
	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response)
		...
		out.print("<td>아이디</td><td>비밀번호</td><td>이름</td><td>이메일</td><td>취미</td><td>가입일</td><td>삭제</td><td>수정</td>");
		...
		for (int i = 0; i < list.size(); i++) {
			...
			out.printf("<td><a href='/pro07/member?command=modMember&id=%s'>수정</a></td>", id);
			out.print("</tr>");
		}
